...
import { consumeSearchDrawerOpenRequest, SEARCH_DRAWER_OPEN_EVENT } from '@/lib/frontend/search/drawer'

const SearchDrawer = dynamic(
  () => import('@/frontend/layout/search/SearchDrawer').then((module) => module.SearchDrawer),
  {
    ssr: false,
  },
)
