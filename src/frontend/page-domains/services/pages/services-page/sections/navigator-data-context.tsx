...
import type { Area, AreaData, Goal, GoalData, ServiceFinal, Treatment, TreatmentData } from '@/frontend/page-domains/services/pages/services-page/sections/service-navigator.types'
