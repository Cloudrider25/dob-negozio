...
import { fetchCheckoutRecommendations } from '@/frontend/page-domains/checkout/client-api/recommendations'
import type { RecommendedProduct } from '@/frontend/page-domains/checkout/shared/contracts'
