...
import { fetchShippingQuote } from '@/frontend/page-domains/checkout/client-api/shipping'
import type { CustomerSnapshot, ShippingOption } from '@/frontend/page-domains/checkout/shared/contracts'
