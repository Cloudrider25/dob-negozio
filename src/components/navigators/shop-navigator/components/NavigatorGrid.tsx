...
import type {
  ...
  NeedId,
  TextureId,
} from '@/components/navigators/shop-navigator/types/navigator'
import { ColumnNeed } from '@/components/navigators/shop-navigator/components/columns/ColumnNeed'
import { ColumnTexture } from '@/components/navigators/shop-navigator/components/columns/ColumnTexture'
import { ColumnProducts } from '@/components/navigators/shop-navigator/components/columns/ColumnProducts'
import { SidePreview } from '@/components/navigators/shop-navigator/components/SidePreview'
import { PathBreadcrumb } from '@/components/navigators/shop-navigator/components/PathBreadcrumb'
import { CenterImageDisplay } from '@/components/navigators/shop-navigator/components/CenterImageDisplay'
      ...
      <div className={styles.relative}>
        <div className={styles.columnsGrid}>
          ...
          {state.selectedNeed && preProductStep === 'need' && (
            <div>
              <ColumnNeed selectedNeed={state.selectedNeed} onSelectNeed={handleSelectNeed} />
            </div>
          )}
